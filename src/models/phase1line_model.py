...
class Phase1LineBackbone(nn.Module):
    def __init__(self):
        ...
        self.conv_1 = nn.Conv2d(
            3, 8, kernel_size=3, stride=1, padding="same", bias=True
        )
...
class CNNModulePhase1Line(pl.LightningModule):
    ...
    def _loss(
        self, line_y_pred, is_last_pred, line_y_gt, is_last_gt, name, factor=1.0
    ):
    ...
    def training_step(self, batch, batch_idx):
        ...
        return self._loss(
            line_y_pred, is_last_pred, line_y_gt, is_last_gt, "train_loss"
        )
